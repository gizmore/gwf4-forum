...
final class Forum_Reply extends GWF_Method
{
	...
	{
		return
			'RewriteRule ^forum/quote/post/([0-9]+)/[^/]+$ index.php?mo=Forum&me=Reply&pid=$1&quote=yes [QSA]'.PHP_EOL.
			'RewriteRule ^forum/reply/to/post/([0-9]+)/[^/]+$ index.php?mo=Forum&me=Reply&pid=$1 [QSA]'.PHP_EOL.
			'RewriteRule ^forum/reply/to/thread/([0-9]+)/[^/]+$ index.php?mo=Forum&me=Reply&tid=$1 [QSA]'.PHP_EOL;
	}
