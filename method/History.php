...
final class Forum_History extends GWF_Method
{
	...
	{
		return 
			'RewriteRule ^forum/history/by/page-(\d+)$ index.php?mo=Forum&me=History&by=&dir=&page=$1 [QSA]'.PHP_EOL.
			'RewriteRule ^forum/history/by/([^/]+)/([DEASC,]+)/page-(\d+)$ index.php?mo=Forum&me=History&by=$1&dir=$2&page=$3 [QSA]'.PHP_EOL.
			'RewriteRule ^forum/history$ index.php?mo=Forum&me=History&by=thread_lastdate&dir=ASC [QSA]'.PHP_EOL;
	}
